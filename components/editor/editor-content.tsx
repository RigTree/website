...
export function EditorContent({ data, isPremium = false, clerkUsername = "" }: EditorContentProps) {
    ...
    <div className="flex flex-col gap-4">
      {deviceType === "desktop" && (
        <div>
          ...
          <PartPicker index={filteredIndex} isPremium={isPremium} clerkUsername={clerkUsername} />
        </div>
      )}
